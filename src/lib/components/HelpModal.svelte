  ...
  const topics = [
    {
      ...
      content: `Honey Did is a secure legacy document creator. It helps you record important information — finances, medical details, legal documents, contacts, and more — so your loved ones have what they need in your absence.
